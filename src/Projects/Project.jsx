...
function Projects() {
   return (
      <>
         ...
         <span style={{color:'#98C942'}}> Mlab south africa Codetribe 2022</span>

         <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', margin:'20px' }}>
         <img src="https://avatars.githubusercontent.com/u/47970844?s=96&amp;v=4" alt="@mahlaule" size="48" height="48" width="48" data-view-component="true" class="avatar circle mr-3"></img>
            <h2 style={{margin:'5px'}}>
               Kevin Mahlauli
            </h2>
